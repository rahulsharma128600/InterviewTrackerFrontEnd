...
export class AppComponent {
  ...
  exportexcel(): void {
    ...
    // const ws: XLSX.WorkSheet = XLSX.utils.json_to_sheet(this.panelList, options);
    // const wb: XLSX.WorkBook = XLSX.utils.book_new();
    // XLSX.utils.book_append_sheet(wb, ws, 'All Data Export');
    // XLSX.writeFile(wb, this.fileName);


    const result = this.panelList.map((panel: { panel_Name: any; available_From: any; available_To: any; email_Id: any; skills: any; manager_Name: any; }) => ({
      // ColumnName: x.data,
      'Panel Name': panel.panel_Name,
      'Availabel From':  panel.available_From, 
      'Availabel To': panel.available_To,
      'Email Id': panel.email_Id,
      'Skills':panel.skills,
      'Manager Name': panel.manager_Name
